...
if (activeTab === "plan") {
  ...
  return (
    <div className="container mx-auto mt-15 px-3 md:p-0">
      ...
      <div className="border-2 flex md:justify-start justify-center gap-20 md:gap-30 items-center border-gray-600 shadow-2xl w-full h-30 mt-5 rounded-2xl">
      ...
      <div>
        ...
        <div className="tabs tabs-lift h-fit">
          ...
          <input
            ...
            value="plan"
            onChange={(e) =>
              setActiveTab(e.target.value as "plan" | "saved")
            }
          />
